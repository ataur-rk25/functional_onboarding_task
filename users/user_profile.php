...
<div class="container">
    <div class="row">
        ...
        <table>
          <tbody>
            <tr>
              <td>Username:</td>
              <td><?php if(!empty($username)): echo $username; endif;?></td>
            </tr>
            <tr>
              <td>Name:</td>
              <td><?php if(!empty($name)): echo $name; endif;?></td>
            </tr>
            <tr>
              <td>Email:</td>
              <td><?php if(!empty($email)): echo $email; endif;?></td>
            </tr>
            <tr>
              <td>Phone:</td>
              <td><?php if(!empty($phone)): echo $phone; endif;?></td>
            </tr>
            <tr>
              <td>Role:</td>
              <td><?php if(!empty($user_role)): echo $user_role; endif;?></td>
            </tr>
          </tbody>
        </table>
        <br>
    ...
    <div class="row">
        ...
        ?>
        <form action="edit_process.php" method="post" id="edit_user_form" style="display:none" onsubmit=" return validateFormEdit();" enctype="multipart/form-data">
            <small>Note: Username cannot be changed</small>
            <div class="form-group-row d-flex">
                <div class="form-group flex-50">    
                  <input type="text" name="username" id="username" placeholder="Username*" value = "<?php if(!empty($username)): echo $username; endif;?>" disabled>    
		              <p class="error_message" id="username_error" style="color: red;"></p>
                </div>
                <div class="form-group flex-50">
                    <input type="text" name="name" id="name" placeholder="Name*" value = "<?php if(!empty($name)): echo $name; endif;?>" required>
